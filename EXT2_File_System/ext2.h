...
#define EXT2_NUM_BLOCKS 128
#define PATH_MAX        1024

#define SUPERBLOCK_POS 1
#define GROUPDESCRIPTOR_POS 2

#define ROOT_INODE_NUMBER 2

#define TOTAL_BLOCK_COUNT   15
#define DIRECT_BLOCK_COUNT  12
#define INDIRECT_BLOCK      12
#define DBLE_INDIRECT_BLOCK 13
#define TPLE_INDIRECT_BLOCK 14

#define NUM_OF_PTRS_IN_BLOCK (EXT2_BLOCK_SIZE / sizeof(unsigned int))
