...
struct frame {
	...
	struct frame *next;	   //The frame that stores the next frame of the frame linkedlist
	struct frame *previous;   //The frame that stores the head frame of the frame linkedlist
};
